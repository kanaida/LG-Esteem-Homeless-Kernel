...
static final int TRANSACTION_dispatchKeyEvent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_dispatchTrackballEvent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_appPrivateCommand = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_toggleSoftInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_finishSession = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
}
public void finishInput() throws android.os.RemoteException;
public void updateExtractedText(int token, android.view.inputmethod.ExtractedText text) throws android.os.RemoteException;
public void updateSelection(int oldSelStart, int oldSelEnd, int newSelStart, int newSelEnd, int candidatesStart, int candidatesEnd) throws android.os.RemoteException;
