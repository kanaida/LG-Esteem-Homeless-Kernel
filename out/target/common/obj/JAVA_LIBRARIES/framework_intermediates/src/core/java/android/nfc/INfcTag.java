...
case TRANSACTION_setIsoDepTimeout:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
this.setIsoDepTimeout(_arg0);
reply.writeNoException();
return true;
}
case TRANSACTION_resetIsoDepTimeout:
{
data.enforceInterface(DESCRIPTOR);
this.resetIsoDepTimeout();
reply.writeNoException();
return true;
}
}
...
public void setIsoDepTimeout(int timeout) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_setIsoDepTimeout, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
public void resetIsoDepTimeout() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_resetIsoDepTimeout, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_setIsoDepTimeout = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_resetIsoDepTimeout = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
}
public int close(int nativeHandle) throws android.os.RemoteException;
public int connect(int nativeHandle, int technology) throws android.os.RemoteException;
public int reconnect(int nativeHandle) throws android.os.RemoteException;
