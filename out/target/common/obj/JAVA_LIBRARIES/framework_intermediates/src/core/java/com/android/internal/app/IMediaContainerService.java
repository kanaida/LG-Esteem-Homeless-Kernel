...
boolean _result = this.copyResource(_arg0, _arg1);
reply.writeNoException();
...
int _arg1;
_arg1 = data.readInt();
android.content.pm.PackageInfoLite _result = this.getMinimalPackageInfo(_arg0, _arg1);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
case TRANSACTION_checkFreeStorage:
{
data.enforceInterface(DESCRIPTOR);
boolean _arg0;
...
boolean _result = this.checkFreeStorage(_arg0, _arg1);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
public boolean copyResource(android.net.Uri packageURI, android.os.ParcelFileDescriptor outStream) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
public android.content.pm.PackageInfoLite getMinimalPackageInfo(android.net.Uri fileUri, int flags) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
public boolean checkFreeStorage(boolean external, android.net.Uri fileUri) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
mRemote.transact(Stub.TRANSACTION_checkFreeStorage, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
static final int TRANSACTION_checkFreeStorage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_getObbInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
}
public java.lang.String copyResourceToContainer(android.net.Uri packageURI, java.lang.String containerId, java.lang.String key, java.lang.String resFileName) throws android.os.RemoteException;
public boolean copyResource(android.net.Uri packageURI, android.os.ParcelFileDescriptor outStream) throws android.os.RemoteException;
public android.content.pm.PackageInfoLite getMinimalPackageInfo(android.net.Uri fileUri, int flags) throws android.os.RemoteException;
