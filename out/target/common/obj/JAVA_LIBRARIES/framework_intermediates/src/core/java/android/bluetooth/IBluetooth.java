...
static final int TRANSACTION_readOutOfBandData = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_createBond = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_createBondOutOfBand = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_cancelBondProcess = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_removeBond = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_listBonds = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getBondState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_setDeviceOutOfBandData = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_getRemoteName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_getRemoteClass = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_getRemoteUuids = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_fetchRemoteUuids = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_getRemoteServiceChannel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_setPin = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_setPasskey = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_setPairingConfirmation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_setRemoteOutOfBandData = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_cancelPairingUserInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_setTrust = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_getTrustState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_isBluetoothDock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_addRfcommServiceRecord = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_removeServiceRecord = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_connectHeadset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_disconnectHeadset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_notifyIncomingConnection = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
}
public boolean isEnabled() throws android.os.RemoteException;
public int getBluetoothState() throws android.os.RemoteException;
public boolean enable() throws android.os.RemoteException;
