...
case TRANSACTION_getLightSensorValue:
{
data.enforceInterface(DESCRIPTOR);
int _result = this.getLightSensorValue();
reply.writeNoException();
reply.writeInt(_result);
return true;
}
case TRANSACTION_getRawLightSensorValue:
{
data.enforceInterface(DESCRIPTOR);
int _result = this.getRawLightSensorValue();
reply.writeNoException();
reply.writeInt(_result);
return true;
}
case TRANSACTION_getLightSensorScreenBrightness:
{
data.enforceInterface(DESCRIPTOR);
int _result = this.getLightSensorScreenBrightness();
reply.writeNoException();
reply.writeInt(_result);
return true;
}
case TRANSACTION_getLightSensorButtonBrightness:
{
data.enforceInterface(DESCRIPTOR);
int _result = this.getLightSensorButtonBrightness();
reply.writeNoException();
reply.writeInt(_result);
return true;
}
case TRANSACTION_getLightSensorKeyboardBrightness:
{
data.enforceInterface(DESCRIPTOR);
int _result = this.getLightSensorKeyboardBrightness();
reply.writeNoException();
reply.writeInt(_result);
return true;
}
case TRANSACTION_setKeyboardLight:
{
data.enforceInterface(DESCRIPTOR);
boolean _arg0;
_arg0 = (0!=data.readInt());
int _arg1;
_arg1 = data.readInt();
this.setKeyboardLight(_arg0, _arg1);
reply.writeNoException();
return true;
}
}
...
public int getLightSensorValue() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getLightSensorValue, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
public int getRawLightSensorValue() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getRawLightSensorValue, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
public int getLightSensorScreenBrightness() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getLightSensorScreenBrightness, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
public int getLightSensorButtonBrightness() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getLightSensorButtonBrightness, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
public int getLightSensorKeyboardBrightness() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getLightSensorKeyboardBrightness, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
public void setKeyboardLight(boolean on, int key) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeInt(((on)?(1):(0)));
_data.writeInt(key);
mRemote.transact(Stub.TRANSACTION_setKeyboardLight, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_getLightSensorValue = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_getRawLightSensorValue = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getLightSensorScreenBrightness = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_getLightSensorButtonBrightness = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_getLightSensorKeyboardBrightness = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_setKeyboardLight = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
}
public void acquireWakeLock(int flags, android.os.IBinder lock, java.lang.String tag, android.os.WorkSource ws) throws android.os.RemoteException;
public void updateWakeLockWorkSource(android.os.IBinder lock, android.os.WorkSource ws) throws android.os.RemoteException;
public void goToSleep(long time) throws android.os.RemoteException;
