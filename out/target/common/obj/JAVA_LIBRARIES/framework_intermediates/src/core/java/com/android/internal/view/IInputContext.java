...
static final int TRANSACTION_setSelection = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_performEditorAction = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_performContextMenuAction = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_beginBatchEdit = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_endBatchEdit = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_reportFullscreenMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_sendKeyEvent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_clearMetaKeyStates = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_performPrivateCommand = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_setComposingRegion = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_getSelectedText = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
}
public void getTextBeforeCursor(int length, int flags, int seq, com.android.internal.view.IInputContextCallback callback) throws android.os.RemoteException;
public void getTextAfterCursor(int length, int flags, int seq, com.android.internal.view.IInputContextCallback callback) throws android.os.RemoteException;
public void getCursorCapsMode(int reqModes, int seq, com.android.internal.view.IInputContextCallback callback) throws android.os.RemoteException;
