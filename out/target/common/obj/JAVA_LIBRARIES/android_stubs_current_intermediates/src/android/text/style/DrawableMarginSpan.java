...
{
public  DrawableMarginSpan(android.graphics.drawable.Drawable b) { throw new RuntimeException("Stub!"); }
public  DrawableMarginSpan(android.graphics.drawable.Drawable b, int pad) { throw new RuntimeException("Stub!"); }
