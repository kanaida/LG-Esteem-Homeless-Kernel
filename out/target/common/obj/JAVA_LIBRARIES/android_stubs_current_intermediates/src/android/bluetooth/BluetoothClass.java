...
public static final int PERIPHERAL_UNCATEGORIZED = 1280;
public static final int PERIPHERAL_KEYBORD = 1344;
public static final int PERIPHERAL_POINTING_DEVICE = 1408;
public static final int PERIPHERAL_COMBO_KEYBORD_POINTING = 1472;
