...
{
protected  SocketChannel(java.nio.channels.spi.SelectorProvider selectorProvider) { super((java.nio.channels.spi.SelectorProvider)null); throw new RuntimeException("Stub!"); }
public static  java.nio.channels.SocketChannel open() throws java.io.IOException { throw new RuntimeException("Stub!"); }
public static  java.nio.channels.SocketChannel open(java.net.SocketAddress address) throws java.io.IOException { throw new RuntimeException("Stub!"); }
public final  int validOps() { throw new RuntimeException("Stub!"); }
public abstract  java.net.Socket socket();
public abstract  boolean isConnected();
public abstract  boolean isConnectionPending();
public abstract  boolean connect(java.net.SocketAddress address) throws java.io.IOException;
