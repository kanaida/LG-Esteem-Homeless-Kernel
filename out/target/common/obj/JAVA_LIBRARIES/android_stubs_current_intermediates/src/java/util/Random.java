...
protected synchronized  int next(int bits) { throw new RuntimeException("Stub!"); }
public  boolean nextBoolean() { throw new RuntimeException("Stub!"); }
public  void nextBytes(byte[] buf) { throw new RuntimeException("Stub!"); }
...
public  int nextInt(int n) { throw new RuntimeException("Stub!"); }
