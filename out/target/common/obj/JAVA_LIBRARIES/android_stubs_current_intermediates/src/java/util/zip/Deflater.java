...
public synchronized  int deflate(byte[] buf, int off, int nbytes) { throw new RuntimeException("Stub!"); }
...
public  void setDictionary(byte[] buf) { throw new RuntimeException("Stub!"); }
