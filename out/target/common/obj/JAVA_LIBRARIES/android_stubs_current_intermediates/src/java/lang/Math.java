...
public static synchronized  double random() { throw new RuntimeException("Stub!"); }
...
public static  float scalb(float d, int scaleFactor) { throw new RuntimeException("Stub!"); }
