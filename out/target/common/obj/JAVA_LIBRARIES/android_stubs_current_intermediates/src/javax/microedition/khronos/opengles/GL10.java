...
public abstract  void glColorPointer(int size, int type, int stride, java.nio.Buffer pointer);
...
public abstract  void glFogfv(int pname, java.nio.FloatBuffer params);
public abstract  void glFogx(int pname, int param);
public abstract  void glFogxv(int pname, int[] params, int offset);
public abstract  void glFogxv(int pname, java.nio.IntBuffer params);
...
public abstract  void glFrustumx(int left, int right, int bottom, int top, int zNear, int zFar);
...
public abstract  void glLightModelfv(int pname, java.nio.FloatBuffer params);
...
public abstract  void glLightModelxv(int pname, java.nio.IntBuffer params);
...
public abstract  void glLightfv(int light, int pname, java.nio.FloatBuffer params);
...
public abstract  void glLightxv(int light, int pname, java.nio.IntBuffer params);
...
public abstract  void glLoadMatrixf(java.nio.FloatBuffer m);
public abstract  void glLoadMatrixx(int[] m, int offset);
public abstract  void glLoadMatrixx(java.nio.IntBuffer m);
...
public abstract  void glMaterialfv(int face, int pname, java.nio.FloatBuffer params);
...
public abstract  void glMaterialxv(int face, int pname, java.nio.IntBuffer params);
public abstract  void glMatrixMode(int mode);
public abstract  void glMultMatrixf(float[] m, int offset);
public abstract  void glMultMatrixf(java.nio.FloatBuffer m);
public abstract  void glMultMatrixx(int[] m, int offset);
public abstract  void glMultMatrixx(java.nio.IntBuffer m);
...
public abstract  void glNormalPointer(int type, int stride, java.nio.Buffer pointer);
public abstract  void glOrthof(float left, float right, float bottom, float top, float zNear, float zFar);
public abstract  void glOrthox(int left, int right, int bottom, int top, int zNear, int zFar);
...
public abstract  void glTexCoordPointer(int size, int type, int stride, java.nio.Buffer pointer);
...
public abstract  void glVertexPointer(int size, int type, int stride, java.nio.Buffer pointer);
