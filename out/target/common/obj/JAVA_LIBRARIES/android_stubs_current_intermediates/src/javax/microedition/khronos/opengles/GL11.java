...
{
public abstract  void glGetPointerv(int pname, java.nio.Buffer[] params);
...
public abstract  void glClipPlanef(int plane, java.nio.FloatBuffer equation);
public abstract  void glClipPlanex(int plane, int[] equation, int offset);
public abstract  void glClipPlanex(int plane, java.nio.IntBuffer equation);
...
public abstract  void glGetClipPlanef(int pname, float[] eqn, int offset);
public abstract  void glGetClipPlanef(int pname, java.nio.FloatBuffer eqn);
public abstract  void glGetClipPlanex(int pname, int[] eqn, int offset);
public abstract  void glGetClipPlanex(int pname, java.nio.IntBuffer eqn);
public abstract  void glGetFixedv(int pname, int[] params, int offset);
public abstract  void glGetFixedv(int pname, java.nio.IntBuffer params);
...
public abstract  void glGetLightfv(int light, int pname, java.nio.FloatBuffer params);
public abstract  void glGetLightxv(int light, int pname, int[] params, int offset);
public abstract  void glGetLightxv(int light, int pname, java.nio.IntBuffer params);
public abstract  void glGetMaterialfv(int face, int pname, float[] params, int offset);
public abstract  void glGetMaterialfv(int face, int pname, java.nio.FloatBuffer params);
public abstract  void glGetMaterialxv(int face, int pname, int[] params, int offset);
public abstract  void glGetMaterialxv(int face, int pname, java.nio.IntBuffer params);
public abstract  void glGetTexEnviv(int env, int pname, int[] params, int offset);
public abstract  void glGetTexEnviv(int env, int pname, java.nio.IntBuffer params);
public abstract  void glGetTexEnvxv(int env, int pname, int[] params, int offset);
public abstract  void glGetTexEnvxv(int env, int pname, java.nio.IntBuffer params);
...
public abstract  void glGetTexParameterxv(int target, int pname, java.nio.IntBuffer params);
...
public abstract  void glPointParameterfv(int pname, java.nio.FloatBuffer params);
...
public abstract  void glPointParameterxv(int pname, java.nio.IntBuffer params);
public abstract  void glPointSizePointerOES(int type, int stride, java.nio.Buffer pointer);
...
public abstract  void glTexEnviv(int target, int pname, java.nio.IntBuffer params);
...
public abstract  void glTexParameterxv(int target, int pname, java.nio.IntBuffer params);
